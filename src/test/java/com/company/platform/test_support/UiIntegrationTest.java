package com.company.platform.test_support;

import com.company.platform.PlatformApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.platform.screen")
@ContextConfiguration(classes = {PlatformApplication.class, UiTestAssistConfiguration.class})
